...
<?php if (isset($scripts) && (! empty($scripts))) : ?>
	...
	<?php endforeach; ?>
<?php endif; ?>
<header id="page-header" class="desktop" style="background-image: url(https://fogodechao.com.br/wp-content/uploads/2023/04/Moema_1920x400-1.png)">
    <article>
        <h1 class="page-titulo">MOEMA, SAO PAULO</h1>
        <!-- <br>
                                        ...
                                        <div class="so-widget-sow-editor so-widget-sow-editor-base">
                                            <div class="siteorigin-widget-tinymce textwidget">
                                                <div class="btn-reserva">
                                                    <a href="https://reservation-widget.tagme.com.br/reservation/schedule/615db30387c266002005fad1/reservationWidget" target="_blank" id="lojabrasilia" type="button" class="fdc-btn-gold" onclick="dataLayer.push({
                                                        'event'
                                                        : 'gaEvent',
                                                        'eventName'
                                                        : 'reserva',
                                                        ...
                                                        : 'click',
                                                        'eventLocal'
                                                        : 'cta_faca_sua_reserva',
                                                        'eventText'
                                                        : 'moema'});">Faça sua reserva</a>
                                                </div>
                                                <h2>MOEMA</h2>
                                                <p>Famosa por ser a primeira casa da rede em São Paulo, Fogo de Chão Moema fica localizada 500 metros do Aeroporto de Congonhas. 10 minutos do São Paulo Expo.</p>
                                                ...
                                                <div class="parking">
                                                    <h2>CONTATO</h2>
                                                    <p><a href="mailto:moema@fogodechao.com.br">moema@fogodechao.com.br</a> – (55) 11 5056-1795 - <img src="https://fogodechao.com.br/wp-content/uploads/2022/09/icon-whats.png"><a style="color: inherit;" href="https://api.whatsapp.com/send/?phone=5511970624267" target="_blank" rel="noopener"> WhatsApp</a></p>
                                                </div>
